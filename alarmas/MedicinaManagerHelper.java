...
public class MedicinaManagerHelper extends BroadcastReceiver {
	...
	public static void setAlarms(Context context) {
		...
		List<MedicinaModel> alarms =  dbHelper.getAlarms();
		
		for (MedicinaModel alarm : alarms) {
			if (alarm.IsEnabled) {
	...
	private static PendingIntent createPendingIntent(Context context, MedicinaModel model) {
		Intent intent = new Intent(context, MedicinaService.class);
		intent.putExtra(ID, model.Id);
		intent.putExtra(IDUSER, model.IdUser);
		intent.putExtra(USER, model.User);
		intent.putExtra(MEDICINE, model.Medicine);
		intent.putExtra(REASON, model.Reason);
		intent.putExtra(DOSES, model.Doses);
