...
public class AdapterListaEventosPacientes extends BaseExpandableListAdapter {
	
	private final SparseArray<TblEventosPacientes> Grupos;
	public LayoutInflater Inflater;
	public Context Context;
	
	public AdapterListaEventosPacientes(Context Context, SparseArray<TblEventosPacientes> Grupos) {
	...
	public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {		
		...
		final TblEventosPacientes Children = (TblEventosPacientes)getChild(groupPosition, childPosition);
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		TblEventosPacientes Grupo = (TblEventosPacientes)getGroup(groupPosition);
