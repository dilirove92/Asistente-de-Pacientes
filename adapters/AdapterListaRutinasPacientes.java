...
public class AdapterListaRutinasPacientes extends BaseExpandableListAdapter {
	
	private final SparseArray<TblRutinasPacientes> Grupos;
	public LayoutInflater Inflater;
	public Context Context;
	
	public AdapterListaRutinasPacientes(Context Context, SparseArray<TblRutinasPacientes> Grupos) {
	...
	public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
		...
		final TblRutinasPacientes Children = (TblRutinasPacientes)getChild(groupPosition, childPosition);
	...
	public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
		...
		TblRutinasPacientes Grupo = (TblRutinasPacientes)getGroup(groupPosition);
