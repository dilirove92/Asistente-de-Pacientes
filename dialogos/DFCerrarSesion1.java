...
public class DFCerrarSesion1 extends DialogFragment {
    @Override
        ...
        builder.setMessage(R.string.DeseaCerrar)
                ...
                .setPositiveButton(R.string.Aceptar, new DialogInterface.OnClickListener()  {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        ((MenuPrincipalActivity)getActivity()).GuardarFinSesion();
                        Log.e("Pasaba por aqui=>", " FIN SESION");
                        //ELIMINAR ALARMAS DEL CELL
                        //((MenuPrincipalActivity)getActivity()).EliminarAlarmas();
